...
const PascaS3Pengumuman_1 = __importDefault(require("./PascaS3Pengumuman"));
const PascaS3Sasaran_1 = __importDefault(require("./PascaS3Sasaran"));
const conn = 'cdc_tracerstudy_pasca_s3';
...
class Services extends Orm_1.BaseModel {
    ...
    static async set_jadwal(waktu_mulai, waktu_berakhir) {
        ...
        return await PascaS3Sasaran_1.default.updateOrCreate(SearchId, Updates);
    }
    ...
    static async update_pengumuman(path_banner, pengumuman, laporan_online, tujuan, target_responden, jadwal, hubungi_kami) {
        ...
        return await PascaS3Pengumuman_1.default.updateOrCreate(SearchId, Updates);
    }
}
exports.default = Services;
//# sourceMappingURL=PascaS3Services.js.map
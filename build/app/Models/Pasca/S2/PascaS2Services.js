...
const PascaS2Sasaran_1 = __importDefault(require("./PascaS2Sasaran"));
const PascaS2Pengumuman_1 = __importDefault(require("./PascaS2Pengumuman"));
const conn = 'cdc_tracerstudy_pasca_s2';
...
class Services extends Orm_1.BaseModel {
    ...
    static async set_jadwal(waktu_mulai, waktu_berakhir) {
        ...
        return await PascaS2Sasaran_1.default.updateOrCreate(SearchId, Updates);
    }
    ...
    static async update_pengumuman(path_banner, pengumuman, laporan_online, tujuan, target_responden, jadwal, hubungi_kami) {
        ...
        return await PascaS2Pengumuman_1.default.updateOrCreate(SearchId, Updates);
    }
}
exports.default = Services;
//# sourceMappingURL=PascaS2Services.js.map
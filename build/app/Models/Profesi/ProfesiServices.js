...
const ProfesiPengumuman_1 = __importDefault(require("./ProfesiPengumuman"));
const ProfesiSasaran_1 = __importDefault(require("./ProfesiSasaran"));
const conn = 'cdc_tracerstudy_profesi';
...
class Services extends Orm_1.BaseModel {
    ...
    static async set_jadwal(waktu_mulai, waktu_berakhir) {
        ...
        return await ProfesiSasaran_1.default.updateOrCreate(SearchId, Updates);
    }
    ...
    static async update_pengumuman(path_banner, pengumuman, laporan_online, tujuan, target_responden, jadwal, hubungi_kami) {
        ...
        return await ProfesiPengumuman_1.default.updateOrCreate(SearchId, Updates);
    }
}
exports.default = Services;
//# sourceMappingURL=ProfesiServices.js.map
...
class D3PengumummanController {
    ...
    async update_pengumuman({ request, session, response }) {
        try {
            ...
            const store = await D3Services_1.default.update_pengumuman(Env_1.default.get('APP_URL') + '/uploads/' + picture_name, pengumuman, laporan_online, tujuan, target_responden, jadwal, hubungi_kami);
            if (store) {
...
exports.default = D3PengumummanController;
//# sourceMappingURL=D3PengumummanController.js.map
	...
	Route.group(() => {
	  ...
	  Route.group(() => {
		...
		Route.group(() => {
		  ...
		  Route.get('ajax-data-pengisi', 'Pasca/S2/PascaS2AdminResponsController.ajax_data_pengisi').as(
			'get_data_pengisi'
		  )
		...
		Route.group(() => {
		  ...
		  Route.get('ajax-data-pengisi', 'Pasca/S3/PascaS3AdminResponsController.ajax_data_pengisi').as(
			'get_data_pengisi'
		  )

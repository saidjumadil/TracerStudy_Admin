...
import Jadwal from './PascaS3Jadwal' //FIXME: sesuaikan
import Sasaran from './PascaS3Sasaran' //FIXME: sesuaikan

const conn: string = 'cdc_tracerstudy_pasca_s3' //FIXME : sesuaikan
